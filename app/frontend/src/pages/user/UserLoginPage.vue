<template>
  <div
    id="userLoginPage"
    class="min-h-[calc(100vh-120px)] flex flex-col items-center justify-center px-4 bg-[#f8fafc]"
  >
    <div class="group w-full max-w-[440px]">
      <div
        class="bg-white border border-gray-100 rounded-2xl overflow-hidden transition-all duration-300 ease-[cubic-bezier(0.165,0.84,0.44,1)] group-hover:-translate-y-1.5 group-hover:shadow-xl p-8 md:p-10"
      >
        <div class="mb-10 text-center">
          <h2 class="text-2xl font-bold text-gray-800 mb-2 tracking-tight">MES 用户登录</h2>
          <div class="text-sm text-gray-400 font-medium">高效生产管理系统</div>
        </div>
