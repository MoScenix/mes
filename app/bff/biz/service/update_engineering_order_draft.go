...
func NewUpdateEngineeringOrderDraftService(Context context.Context, RequestContext *app.RequestContext) *UpdateEngineeringOrderDraftService {
	return &UpdateEngineeringOrderDraftService{RequestContext: RequestContext, Context: Context}
}

func (h *UpdateEngineeringOrderDraftService) Run(req *mes.UpdateEngineeringOrderRequest) (resp *mes.BaseResponseBoolean, err error) {
